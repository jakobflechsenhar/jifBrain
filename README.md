...
Paste notes/images into the AI Generate page and Claude returns flashcard pairs to review and save in bulk. Requires a Anthropic API key with preloaded credits at console.anthropic.com.
