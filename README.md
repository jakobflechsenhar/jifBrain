...
Paste notes/images into the AI Generate page and Claude returns flashcard pairs to review and save in bulk. Requires an Anthropic API key wit preloaded credits at console.anthropic.com.
